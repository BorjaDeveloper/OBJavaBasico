...
motocicleta, por ejemplo, herede de la clase padre Vehículo.
 */
...
public class Motocicleta extends Vehiculo {
    ...
    public Motocicleta(String fabricante, String modelo, Double cc, int year, boolean sport, int speed,
