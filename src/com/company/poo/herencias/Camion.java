...
camión, por ejemplo, herede de la clase padre Vehículo.
 */
public class Camion extends Vehiculo {
    ...
    public Camion(String fabricante, String modelo, Double cc, int year, boolean sport, int speed,
                  Motor motor, double capacidadCarga) {
